 ...
 *  
 * @author Wenjian Li 
 * @version for UCSB CS56, W14, 03/14/2014
 */
...
public class AnimatedPictureViewer extends JFrame
{
    ...
    static final double startingYPos = 310;
	...
	// Set your own title
	setTitle("Oliver's Animted Drawing");
	...
	getContentPane().addMouseListener(
						new MouseAdapter(){
							...
							animate = new Animate();
							animate.start();
							System.out.println("What the fruit? Not giving to you! T^T Moving, moving, moving away...");
						    }//end mouseEntered
							...
							animate = null;
							System.out.println("You so clever!!! Now it's ready for you to eat!");
						    }//end MouseExited
